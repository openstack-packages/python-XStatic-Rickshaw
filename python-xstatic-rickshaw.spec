...
Version:        XXX
Release:        1%{?dist}
Summary:        Rickshaw JavaScript library packaged for setuptools

License:        BSD
URL:            http://git.openstack.org/cgit/stackforge/xstatic-rickshaw/
...
%files
%doc README.txt
%{python_sitelib}/XStatic_Rickshaw-%{version}-py?.?.egg-info
%{python_sitelib}/XStatic_Rickshaw-%{version}-py?.?-nspkg.pth
%{python_sitelib}/xstatic/pkg/rickshaw
